...
def cadastrar():
	...
	l_competencias.place(x=530, y=85)
	...
	def novo_planejamento():
		...
		competencias_gerais = ecompgs_nome.get()
		competencias_especifica = ecompes_nome.get()
		habilidades = ehab_nome.get()
		objetos = enome_objetos.get()
		descricao = enome_descricao.get()
		recursos = enome_recursos.get()
		avaliacao = enome_avaliacao.get()

		lista_planejamento = [tema, objetivos, area_conhecimento, disciplina, competencias_gerais,competencias_especifica, habilidades, objetos, descricao, recursos, avaliacao]
		...
		ecompgs_nome.delete(0,END)
		ecompes_nome.delete(0,END)
		ehab_nome.delete(0,END)
	...
	def update_planejamenento():
		try:
			...
			ecompgs_nome.insert(0, tree_lista[5])
			ecompes_nome.insert(0,tree_lista[6])
			ehab_nome.insert(0, tree_lista[7])
			enome_objetos.insert(0, tree_lista[8])
			enome_descricao.insert(0, tree_lista[9])
			enome_recursos.insert(0, tree_lista[10])
			enome_avaliacao.insert(0, tree_lista[11])
	...
	def mostrar_planejamento():
		...
		list_header = ['id','Tema', 'Ojetivos','Área de Conhecimento','Disciplina','Competências Gerais','Competências Específicas','Habilidades','Objetos', 'Descrição', 'Recursos', 'Avaliação']
		...
		hd=["nw","nw","nw","nw","nw","nw","nw","nw","nw","nw","nw","nw"]
		h=[30,130,130,130,130,130,120,100,100,100,100,130]
		n=0
...
def salvar():
	...
	botao_exportarp.place(x=590, y=60)
	...
	botao_exportarcg.place(x=590, y=100)
	...
	botao_exportarce.place(x=590, y=140)

	botao_exportarh = Button(frame_detalhes,command=exportar_habilidades, anchor=CENTER, text="Exportar Habilidades".upper(), width=20, overrelief=RIDGE, font=('Ivy 7 bold'), bg=co3, fg=co1)
	botao_exportarh.place(x=590, y=180)
